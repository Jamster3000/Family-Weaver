...
<Popup isOpen={open_popup} showCloseButton={true} onClose={() => open_popup = false}>
    <Card width="70%">
        {#if firstTime}
            ...
            <p>Family Weaver helps you build and visualize your family tree. Add members, track relationships, and explore your genealogy—all offline, no limits.</p>
        ...
        {:else}
            ...
            <div class="tree-reassured">
                <p>Your current tree is already saved and will not be lost. You will be switched to the new tree you create but can switch back at any time.</p>
            </div>
        {/if}

        <p>Tip: Use a surname or your home person's name (e.g., "Smith Family Tree")</p>
