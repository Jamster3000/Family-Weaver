...
<style>
	...
	.secondary {
		...
		font-weight: 800px;
		border: 3.5px solid var(--secondary-colour);
		box-shadow: none;
	}
	...
	:root[data-theme="high-contrast-dark"] .primary {
		color: var(--black);
	}

	:root[data-theme="high-contrast-dark"] :global(svg) {
